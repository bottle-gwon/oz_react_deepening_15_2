...
const Boards = ({ type }) => {
  ...
  return (
    <div ref={setNodeRef} className={`select-none w-full flex flex-col h-full ${
      ...
      <div className="flex flex-col gap-2 p-4">
        ...
        <SortableContext items={filteredData} strategy={verticalListSortingStrategy}>
          ...
          {filteredData.length === 0 && (
            <div className="flex-1 min-h-[200px] border-dashed border-slate-300 rounded-md flex items-center justify-center text-slate-400">
              이 영역으로 항목을 드래그하세요.
            </div>
          )}
        </SortableContext>
